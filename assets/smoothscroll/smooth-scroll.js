!(function () {
  ...
  function B(t) {
    ...
    if (
      ...
      return !0;
    if (
      (F(o, "button") || (F(o, "input") && r.test(o.type))) &&
      t.keyCode === v
    )
      return !0;
  ...
  se && ie && (q(se, T, ue), q("mousedown", C), q("load", x)),
    (de.destroy = function () {
      t && t.disconnect(),
        V(se, T),
        V("mousedown", C),
    ...
    window.SmoothScrollOptions && de(window.SmoothScrollOptions),
