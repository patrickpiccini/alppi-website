!(function () {
  ...
  r && (e = jQuery),
    ...
    (Element.prototype.footerReveal = function () {
      ...
      function n() {
        !t && this.offsetHeight <= window.outerHeight
          ? ((this.style.zIndex = "-999"),
            (this.style.position = "fixed"),
            (this.style.bottom = "0"),
            (this.style.width = e.offsetWidth),
            (e.style.marginBottom = this.offsetHeight))
          : ((this.style.zIndex = ""),
            (this.style.position = ""),
            (this.style.bottom = ""),
            (this.style.width = ""),
        ...
        ? this.addEventListener(
            ...
            function () {
              var e = this,
                n = arguments;
              function a() {
                o || t.apply(e, n), (i = null);
              }
              i ? clearTimeout(i) : o && t.apply(e, n),
                (i = setTimeout(a, r || 100));
            })
          )
  ...
  if (
    (s(function () {
      ...
      function s(e) {
        setTimeout(function () {
          o(e, ".mbr-parallax-background").forEach(function (e) {
            jarallax &&
      ...
      if (
          ...
          : u ||
            ...
            e(document).on("add.cards", function (e) {
              document
                ...
                o(e.target, ".mbr-section--full-height").length &&
        ...
        r &&
          e(document).on("add.cards changeParameter.cards", function (e) {
            var t = o(e.target, ".mbr-section--16by9");
            t.length
              ? t.forEach(function (e) {
                  e.setAttribute("data-16by9", "true"), n(e);
                })
              : o(e.target, "[data-16by9]").forEach(function (e) {
        ...
        if (
          ...
          e(document).on("add.cards", function (t) {
            ...
            e(document).on("changeParameter.cards", function (t, n, r, o) {
              if ("bg" === n)
                switch (
                  ((i = t.target),
                  ...
                  case "type":
                    !0 === r.parallax && s(t.target);
                    break;
                  case "value":
                    "image" === r.type && !0 === r.parallax && s(t.target);
                    break;
                  case "parallax":
                    !0 === r.parallax && s(t.target);
                }
      ...
      var c,
        ...
        p = !d();
      function g(e) {
        o(e, "[data-bg-video]").forEach(function (e) {
          ...
          if (n) {
            ...
            if (
              (o.classList.add("mbr-background-video-preview"),
              (o.style.display = "none"),
              (o.style.backgroundSize = "cover"),
              (o.style.backgroundPosition = "center"),
              e.querySelector(".mbr-background-video-preview") ||
                e.childNodes[0].before(o),
              r && (/youtu\.?be/g.test(r[3]) || /vimeo/g.test(r[3])))
            ) {
              if (r && /youtu\.?be/g.test(r[3])) {
                var i =
                  "http" + ("https:" === location.protocol ? "s" : "") + ":";
                i += "//img.youtube.com/vi/" + r[6] + "/maxresdefault.jpg";
                var a = new Image();
                (a.onload = function () {
                  if (120 === (a.naturalWidth || a.width)) {
                    var n = a.src.split("/").pop();
                    switch (n) {
                      case "maxresdefault.jpg":
                        a.src = a.src.replace(n, "sddefault.jpg");
                        break;
                      case "sddefault.jpg":
                        a.src = a.src.replace(n, "hqdefault.jpg");
                        break;
                      default:
                        t &&
                    ...
                    (o.style.backgroundImage = 'url("' + a.src + '")'),
                      (o.style.display = "block");
                  ...
                  c.classList.add("mbr-video-foreground"),
                    c.appendChild(i),
                    s.appendChild(c),
                    l.appendChild(s),
                    i.classList.add("mbr-background-video");
                  e.childNodes[1].before(l);
                  var d = {
                      height: a.naturalHeight,
                      width: a.naturalWidth,
                      scale: a.naturalHeight / a.naturalWidth,
                    },
                    u = {
                      height: i.parentNode.clientHeight,
                      width: i.parentNode.clientWidth,
                      scale:
                        i.parentNode.clientHeight / i.parentNode.clientWidth,
                    },
                    m = {
                      height: d.height < u.height ? d.height : u.height,
                      width: d.width > u.width ? d.width : u.width,
                    };
                  m.height / m.width != d.scale &&
                    (m.height = m.width * d.scale);
                  var f = {
                      height: m.height,
                      width: m.width,
              ...
              } else if (r && /vimeo/g.test(r[3])) {
                var l = new XMLHttpRequest();
                l.open(
                  "GET",
                  "https://vimeo.com/api/v2/video/" + r[6] + ".json",
                  !0
                ),
                ...
                s.classList.add("mbr-background-video");
                e.childNodes[1].before(s);
                var c = {
                    id: n,
                    loop: !0,
                    background: !0,
                  ...
                  d = new Vimeo.Player(s, c),
                  u = d.element.parentNode;
                (u.style.overflow = "hidden"),
                  (d.element.style.pointerEvents = "none"),
                  (d.element.style.marginLeft =
                    "-" + (d.element.scrollWidth - u.scrollWidth) / 2 + "px"),
                  (d.element.style.minHeight = "100vh"),
                  (d.element.style.minWidth = "177.77vh");
              }
            } else
              t &&
                ((o.style.backgroundImage =
      ...
      t &&
        e(document).on("changeParameter.cards", function (e, t, n, r) {
          if ("bg" === t)
            switch (r) {
              case "type":
              case "value":
        ...
        t ||
          Array.from(document.body.children)
            ...
            .forEach(function (t) {
              t.dispatchEvent(new CustomEvent("add.cards")),
                r && e(t).trigger("add.cards");
            }),
            ...
            try {
              ...
              do {
                if (t.hash) {
                  ...
                  document
                    .querySelector(n ? "body" : t.hash)
                    .forEach(function (n) {
                      e.preventDefault();
                      var r = t.parents().some(function (e) {
    ...
    t ||
      (r &&
        e.fn.socialLikes &&
        e(document).on("add.cards", function (e) {
          o(e.target, ".mbr-social-likes").forEach(function (e) {
      ...
      r &&
        e(document).on("add.cards", function (e) {
          e.target.classList.contains("mbr-reveal") && e.target.footerReveal();
        }),
      s(function () {
  ...
  if (
    ...
    const e = document.querySelectorAll(".dropdown-toggle.show"),
      t = document.querySelectorAll(".dropdown-menu.show");
    if (
      (e.forEach((e) => {
              ...
              .forEach(function (e) {
                e.addEventListener("mouseover", function () {
                  if (e.classList.contains("open")) {
                    e.querySelector("a").dispatchEvent(
    ...
    (t ||
        ...
        document.body.querySelectorAll(".clients").forEach(function (e) {
          ...
          e.getAttribute("data-isinit") ||
            ...
            t.querySelectorAll(".carousel-inner").forEach(function (e) {
              e.setAttribute("class", "carousel-inner slides" + r);
            }),
            ...
            t
              ...
              .forEach(function (e) {
                r < 2
                  ...
                  : e.setAttribute("class", "col-md-12 col-lg-" + 12 / r);
              }),
            ...
            t.querySelectorAll(".carousel-item").forEach(function (e) {
              for (var t = e, n = 1; n < r; n++) {
                ...
                i.classList.add("cloneditem-" + n),
                  ...
                  i.setAttribute("data-cloned-index", o),
          ...
          .forEach(function (e) {
            e.addEventListener("click", function () {
              ...
              if (
                ...
                (e.classList.contains("collapsed")
                  ? (r.classList.remove("mbri-arrow-up"),
                    r.classList.add("mbri-arrow-down"))
                  : (r.classList.remove("mbri-arrow-down"),
                    r.classList.add("mbri-arrow-up")),
                -1 != t.indexOf("accordion"))
              ) {
                var o = e.closest(".accordionStyles");
      ...
      0 != document.querySelectorAll(".mbr-slider.carousel").length &&
        document.querySelectorAll(".mbr-slider.carousel").forEach(function (t) {
          var n = t,
            o = n.querySelectorAll(".carousel-control"),
  ...
  function v(e, t, n) {
    ...
    r.getAttribute("style") ||
      r.setAttribute("style", "-webkit-flex-basis: auto; flex-basis: auto;"),
      o.contains("row") && (o.remove("row"), o.add("media-container-row")),
    ...
    Array.from(e.children).forEach(function (e) {
      ...
      e.setAttribute(
        ...
        `{ ${(function (e) {
          ...
          if (n) {
            for (
              var r = [], o = Array.from(n.children), i = 0;
              i < o.length;
              i++
            )
              r.push(`"${o[i].getAttribute("stop-color")}"`);
            (t = `"lineargradient": [${r}],`),
  ...
  document.querySelectorAll('input[type="range"]').forEach(function (e) {
    ...
    t && r
      ? e(document)
          ...
          .on("changeParameter.cards", function (t, n, r) {
