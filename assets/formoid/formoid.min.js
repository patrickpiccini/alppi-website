var Formoid = (function () {
    var e = "https://formoid.net/api/push";
    function t(e, t) {
    ...
    return (
      (n.prototype.email = function (e) {
        return r.call(this, "email", arguments);
      }),
      (n.prototype.title = function (e) {
        return r.call(this, "title", arguments);
      }),
      (n.prototype.data = function (e) {
        return r.call(this, "data", arguments);
      }),
        ...
        return t(e, {
          ...
          data: JSON.stringify({
            ...
            form: {
              ...
              data: arguments.length ? r : this.__data__,
            },
          }),
        }).then(function (e) {
          var t;
...
formComponents.forEach(function (e) {
  var t,
    r = "FORM" === e.tagName ? e : e.querySelector("form"),
    n = e.querySelector("[data-form-alert]"),
    a = e.getAttribute("data-form-title")
      ? e
      : e.querySelector("[data-form-title]"),
    i = e.querySelector('[type="submit"]'),
    o = e.querySelectorAll("[data-form-field]"),
    s = n.innerHTML;
  r.addEventListener("change", function (e) {
    "file" === e.target.type &&
      ...
      (n.innerHTML = "File size must be less than 1mb"),
      i.classList.add("btn-loading"),
      i.setAttribute("disabled", !0));
  }),
    r.addEventListener("submit", function (l) {
      if (
        (l.stopPropagation(),
        l.preventDefault(),
        !i.classList.contains("btn-loading"))
      ) {
        var c = o;
        r.classList.add("form-active"),
          i.classList.add("btn-loading"),
          i.setAttribute("disabled", !0),
          (n.innerHTML = ""),
          (t =
            ...
            Formoid.Form({
              ...
              title: a.getAttribute("data-form-title") || a.innerText,
            })),
          Promise.all(
            Array.prototype.map.call(c, function (e) {
              return (function (e) {
                return new Promise(function (t, r) {
                  if ("email" === e.getAttribute("name") && !isValidEmail(e))
                    return r(new Error("Form is not valid"));
                  var n =
            ...
            .then(
              function (e) {
                r.reset(),
                  r.classList.remove("form-active"),
                  (n.innerText = s || e),
                  n.classList.remove("alert-danger"),
                  n.classList.add("alert-success");
              },
              function (e) {
